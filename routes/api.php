<?php
    ...
    Route::middleware(['json.response', 'cors'])->group(function () {
        ...
        Route::prefix('search')->group(function () {
            Route::get('/words/{word?}/{exact?}', 'API\SearchController@searchWords')->name('search.words');
            Route::get('/phrases/{phrase?}/{exact?}', 'API\SearchController@searchPhrases')->name('search.phrases');
        });

        Route::get('/test', 'API\SearchController@testAPI')->name('test.api');
